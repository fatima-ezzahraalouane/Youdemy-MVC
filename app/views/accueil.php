	...
	<div class="page-wraper">
			...
			<div class="sticky-header navbar-expand-lg">
				<div class="menu-bar clearfix">
					<div class="container clearfix">
						<!-- Header Logo ==== -->
						<div class="menu-logo">
							<a href="accueil.php"><img src="../assets/images/youdemy.png" alt=""></a>
						</div>
						<!-- Mobile Nav Button ==== -->
						...
						<div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
							...
							<ul class="nav navbar-nav">
								<li class="active"><a href="accueil.php" class="active">Accueil </a></li>
								<li class="add-mega-menu"><a href="cours.php">Cours </a></li>
		...
		<div class="page-content bg-white">
						...
						<ul> <!-- SLIDE  -->
							<li data-index="rs-100"
								...
								<div class="tp-caption Newspaper-Subtitle   tp-resizeme"
									...
									est la vision de Youdemy, une plateforme dédiée à offrir des cours en ligne de qualité pour inspirer et former les apprenants du monde entier.
								</div>
								<!-- LAYER NR. 4 -->
								<div class="tp-caption Newspaper-Button rev-btn "
									...
									style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:var(--primary) !important; border:0; border-radius:30px; margin-right:5px;">EN SAVOIR PLUS </div>
								<div class="tp-caption Newspaper-Button rev-btn"
			...
			<div class="content-block">
									...
									<div class="col-lg-4 col-md-4 col-sm-6">
										<div class="service-bx">
											<div class="action-box">
												<img src="<?php echo htmlspecialchars($cat->getImageUrl()); ?>" alt="image">
											</div>
											<div class="info-bx text-center">
												<div class="feature-box-sm radius bg-white">
													<i class="fa fa-bank text-primary"></i>
												</div>
												<h4><a href="#"><?php echo htmlspecialchars($cat->getNom()); ?></a></h4>
												<a href="#" class="btn radius-xl">Explorer les cours</a>
											</div>
										</div>
									</div>
								<?php endforeach; ?>
				...
				<!-- Form -->
				<div class="section-area section-sp1 ovpr-dark bg-fix online-cours mt-4" style="background-image:url(assets/images/background/bg1.jpg);">
					<div class="container">
						<div class="row">
